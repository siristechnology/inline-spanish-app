...
export type CommentList1ItemProps = ThemedComponentProps &
	ListItemProps &
	ComponentProps
...
> {
	...
	public render(): React.ReactNode {
		...
		const repliesElement: RepliesElement | null =
			this.shouldRenderReplies() && this.renderReplyList()
...
export const CommentList1Item = withStyles(
	CommentList1ItemComponent,
	(theme: ThemeType) => ({
		container: {
			flex: 1,
