...
import { Tab, TabProps, TabView, TabViewProps } from 'react-native-ui-kitten/ui'
...
class LayoutMenuComponent extends React.Component<LayoutMenuProps> {
	...
	public componentWillUpdate(nextProps: LayoutMenuProps) {
		const nextLoadingMap: TabLoadingMap = this.createTabLoadingMap(
	...
	public render(): React.ReactNode {
		...
		return (
			<ThemeProvider
				theme={{ ...this.props.theme, ...themes['App Theme'] }}>
				<TabView
					...
					<Tab icon={GridIconOutline}>
						<LayoutGridList
							contentContainerStyle={
								themedStyle.listContentContainer
							}
							data={data}
...
export const LayoutMenu = withStyles(
	LayoutMenuComponent,
	(theme: ThemeType) => ({
