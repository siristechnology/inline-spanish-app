...
import { ListItem, ListItemProps, Text } from 'react-native-ui-kitten/ui'
...
export type LayoutGridListItemProps = ThemedComponentProps &
	ListItemProps &
	ComponentProps
...
export const LayoutGridListItem = withStyles(
	LayoutGridListItemComponent,
	(theme: ThemeType) => ({
		container: {
